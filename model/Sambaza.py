...
def main():
    ...
    st.markdown("Which supplier is more suitable?")
    st.sidebar.markdown("Which supplier is more suitable?")
    ...
    def split(df):
        y = df['Supplier name'] 
        x = df.drop(columns=['Supplier name'])
    ...
    df = load_data()
    class_names = ['Reliable Supplier', 'Unreliable Supplier']
    ...
    if st.sidebar.checkbox("Show raw data", False):
        st.subheader("Supplier Data Set (Classification)")
        st.write(df)
